...
const Intro = () => {
    return ( 
        <div className="__intro">
            <div className="__intro-left">
                <div className="__intro-left-wrapper">
                    <h2 className="__intro-text">Hello, My name is</h2>
                    <h1 className="__intro-name">Usman Mushtaq</h1>
                    <div className="__intro-title">
                        <div className="__intro-title-wrapper">
                            <div className="__intro-title-item">Front-end developer</div>
                            <div className="__intro-title-item">UX/UI designer</div>
                            <div className="__intro-title-item">UI designer</div>
                            <div className="__intro-title-item">Writer</div>
                        </div>
                    </div>
                    <div className="__intro-description">
                        Hi, I am Muhammad Usman, frontend developer with a 
                        passion for solving design problems, visual design,
                         UX and clean code
                    </div>
                    <svg width="24px" 
                    height="24px" 
            ...
            <div className="__intro-right">
                <div className="__intro-bg"></div>
                <img src={Me} alt="img" className="__intro-img" />
            </div>
        </div>
     );
}
